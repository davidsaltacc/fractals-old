...
fn apply_post_function(z: vec2<f32>) -> vec2<f32> {
	...
	switch (post_function) {
		default: { return z; }
		case 0u: { return z; }
		case 1u: { return c_sin(z); }
		case 2u: { return c_cos(z); }
		case 3u: { return c_sinh(z); }
		case 4u: { return c_cosh(z); }
		case 5u: { return c_tan(z); }
		case 6u: { return c_tanh(z); }
		case 7u: { return c_log(z); }
		case 8u: { return c_sqrt(z); }
		case 9u: { return c_abs(z); }
		case 10u: { return c_exp(z); }
		case 11u: { return c_atan(z); }
		case 12u: { return c_asin(z); }
		case 13u: { return c_acos(z); }
		case 14u: { return c_asinh(z); }
		case 15u: { return c_acosh(z); }
		case 16u: { return c_atanh(z); }
		case 17u: { return c_inv(z); }
	}
} 
